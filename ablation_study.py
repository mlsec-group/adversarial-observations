...
from attacks import our_attack_wo_steps, our_attack_wo_approximation, add_perturbation
...
def path_for(epsilon, target, steps):
    return f"data/results/ablation_{target}_{epsilon}eps_{steps}steps.json"
...
if __name__ == "__main__":
    ...
    for i, target in enumerate(targets[args.offset:(args.offset+args.locations)]):
