...
data = gpd.read_file("../GHS_UCDB_GLOBE_R2024A.gpkg", layer="GHS_UCDB_THEME_GHSL_GLOBE_R2024A")
...
centroids = gpd.read_file("../GHS_UCDB_GLOBE_R2024A.gpkg", layer="UC_centroids")
